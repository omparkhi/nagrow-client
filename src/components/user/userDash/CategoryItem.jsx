...
const CategoryItem = [
  ...
  { id: 2, name: "Chole", image: cholebhature, searchKey: "cholebhature" },
  { id: 3, name: "Dosa", image: dosa, searchKey: "dosa" },
  { id: 4, name: "Ice Cream", image: icecream, searchKey: "ice-cream" },
  { id: 5, name: "Idli", image: idli, searchKey: "idli" },
  { id: 6, name: "Momos", image: momos, searchKey: "momos" },
  { id: 7, name: "Pav Bhaji", image: pavbhaji, searchKey: "pavbhaji" },
  { id: 8, name: "Pizza", image: pizza, searchKey: "pizza" },
  { id: 9, name: "Burger", image: plainburger, searchKey: "plainburger" },
