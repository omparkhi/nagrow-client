  ...
  return (
    <>
      <section className="h-screen w-full bg-[#131222] text-center">
        <div className="h-[30%] pt-20 pb-4 gap-4">
          <h2 className="text-slate-200 font-bold text-4xl md:text-7xl">Log In</h2>
          <p className="text-slate-400 text-xl m-2">Please sign in to your existing account</p>
        </div>

      <div className="h-[75%] bg-white rounded-t-[50px] flex justify-center px-4 lg:px-12 py-5 mt-4">
        <div className="w-full max-w-lg bg-white text-black rounded-[15px] lg:border-2 border-[#f4f1f7] p-4">
            <label className="block  mt-4 text-left w-full text-gray-700">Phone Number</label>
            <input
              type="tel"
              pattern="[0-9]{10}"
              maxLength={10}
            ...
            <label className="block  mt-4 text-left w-full text-gray-700 ">Password</label>
            <input
              type="password"
            ...
            <button className="bg-[#ff5733] text-white w-full py-3 rounded-md font-bold mt-5 cursor-pointer">
              LOG IN
            </button>

            <p className="text-center text-sm mt-5">
              Don’t have an account?{" "}
              <Link to="/signup" className="text-[#ff5733] text-sm font-semibold">
                SIGN UP
              </Link>
            </p>
